            ...
            <v-form ref="searchForm">
                <v-row class="mx-0">
                    <v-col cols="4">
                        ...
                        <v-autocomplete :filter="getList" v-model="compte" return-object :rules="obligationRule" :items="comptes"
...
export default {
    ...
    methods: {
        async getEcritures() {
            if (!this.$refs.searchForm.validate() || !this.compte || !this.date1 || !this.date2) {
