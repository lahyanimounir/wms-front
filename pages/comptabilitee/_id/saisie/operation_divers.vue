            ...
            <v-form class="form" ref="ecritureForm">
                <v-row class="mx-0 mt-2">
                    <v-col cols="2">
                        ...
                        <v-autocomplete  hide-details v-model="editedItem.journal" return-object :rules="obligationRule" label="Journal*"
                            :items="journaux" dense placeholder="Journal" item-text="nom" item-value="id">
                ...
                <v-row class="mx-0">
                    ...
                    <v-col cols="2">
                        ...
                        <v-text-field v-model="editedItem.libelle" :rules="obligationRule" label="Libellé *" dense></v-text-field>
                    </v-col>
                    <v-col cols="2">
