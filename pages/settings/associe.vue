                            ...
                            <v-container>
                                <v-row>
                                    ...
                                    <v-col cols="6" class="py-0">
                                        ...
                                        <v-text-field counter maxlength="30" :rules="obligationRule" v-model="editedItem.intitulee" outlined dense
                                            placeholder="Intitulée"></v-text-field>
                                    </v-col>
                             
                                    <v-col cols="12" class="py-0">
                                        <label for="">Cne/ Passport / If *</label>
                                        <v-text-field counter  :rules="obligationRule" v-model="editedItem.code" outlined dense
                                            placeholder="Code" type="number"></v-text-field>
                                    </v-col>
...
export default {
    ...
    computed: {
        formTitle() {
            return this.editedIndex === -1 ? 'Ajouter Localisation' : 'Modifier Localisation'
        },
    },
    ...
    methods: {
        async initialize() {
            let url = process.env.Name_api + "/localisations";
        ...
        async update() {
            try {
                let url = process.env.Name_api + "/localisations/" + this.editedItem.id;
        ...
        async delete(val) {
            console.log(val)
            try {
                let url = process.env.Name_api + "/localisations/" + val.id;
