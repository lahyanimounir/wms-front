          ...
          ></v-divider> -->
                ...
                <v-dialog v-model="dialog" max-width="600px">
                    ...
                    <v-toolbar dark color="primary">
                        ...
                        <v-toolbar-title> Ajouter devise</v-toolbar-title>
                            ...
                            <v-container>
                                <v-row>
                                    ...
                                    <v-col cols="12" class="py-0">
                                        ...
                                        <v-text-field counter maxlength="40" :rules="obligationRule" v-model="editedItem.taux" outlined dense
...
export default {
    ...
    computed: {
        formTitle() {
            return this.editedIndex === -1 ? 'Ajouter devise' : 'Modifier devise'
        },
    },
    ...
    methods: {
        ...
        async update() {
            try {
                let url = process.env.Name_api + "/Devises/" + this.editedItem.id;
        ...
        async delete(val) {
            console.log(val)
            try {
                let url = process.env.Name_api + "/Devises/" + val.id;
