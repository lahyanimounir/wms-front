          ...
          ></v-divider> -->
                ...
                <v-dialog v-model="dialog" max-width="600px">
                    ...
                    <v-toolbar dark color="primary">
                        ...
                        <v-toolbar-title> Ajouter Echeance</v-toolbar-title>
                            ...
                            <v-container>
                                <v-row>
                                    ...
                                    <v-col cols="12" class="py-0">
                                        ...
                                        <v-text-field counter maxlength="40" :rules="obligationRule" v-model="editedItem.code" outlined dense
                                            placeholder="Code"></v-text-field>
                                    </v-col>

                                    <v-col cols="12" class="py-0">
                                        <label for="">Nombre de jours *</label>
                                        <v-text-field counter maxlength="40" :rules="obligationRule" v-model="editedItem.nbr_jours" outlined dense
                                            placeholder="Nombre de jours"></v-text-field>
                                    </v-col>
...
export default {
    data: () => ({
        ...
        headers: [
            ...
            { text: 'Nombre de Jours', value: 'nbr_jours' },
    ...
    computed: {
        formTitle() {
            return this.editedIndex === -1 ? 'Ajouter Echeance' : 'Modifier Echeance'
        },
    },
    ...
    methods: {
        async initialize() {
            let url = process.env.Name_api + "/echeances";
        ...
        async update() {
            try {
                let url = process.env.Name_api + "/echeances/" + this.editedItem.id;
        ...
        async delete(val) {
            console.log(val)
            try {
                let url = process.env.Name_api + "/echeances/" + val.id;
