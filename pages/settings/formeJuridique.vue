          ...
          ></v-divider> -->
                ...
                <v-dialog v-model="dialog" max-width="600px">
                    ...
                    <v-toolbar dark color="primary">
                        ...
                        <v-toolbar-title> Ajouter forme Juridique</v-toolbar-title>
...
export default {
    ...
    methods: {
        async initialize() {
            let url = process.env.Name_api + "/formJuridiques";
        ...
        async update() {
            try {
                let url = process.env.Name_api + "/formJuridiques/" + this.editedItem.id;
        ...
        async delete(val) {
            console.log(val)
            try {
                let url = process.env.Name_api + "/formJuridiques/" + val.id;
