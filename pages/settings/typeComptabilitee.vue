          ...
          ></v-divider> -->
                ...
                <v-dialog v-model="dialog" max-width="600px">
                    ...
                    <v-toolbar dark color="primary">
                        ...
                        <v-toolbar-title> Ajouter type de Comptablilité</v-toolbar-title>
...
export default {
    ...
    computed: {
        formTitle() {
            return this.editedIndex === -1 ? 'Ajouter type comptabilitée' : 'Modifier type comptabilitée'
        },
    },
    ...
    methods: {
        ...
        async update() {
            try {
                let url = process.env.Name_api + "/typeComptabilitees/" + this.editedItem.id;
        ...
        async delete(val) {
            console.log(val)
            try {
                let url = process.env.Name_api + "/typeComptabilitees/" + val.id;
