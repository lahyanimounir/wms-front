          ...
          ></v-divider> -->
                ...
                <v-dialog v-model="dialog" max-width="600px">
                    ...
                    <v-toolbar dark color="primary">
                        ...
                        <v-toolbar-title> Ajouter ville</v-toolbar-title>
                            ...
                            <v-container>
                                <v-row>
                                    ...
                                    <v-col cols="12" class="py-0">
                                        ...
                                        <v-text-field counter maxlength="40" :rules="obligationRule" v-model="editedItem.code_postal" outlined dense
                                            placeholder="Code postal"></v-text-field>
                                    </v-col>
...
export default {
    ...
    computed: {
        formTitle() {
            return this.editedIndex === -1 ? 'Ajouter ville' : 'Modifier ville'
        },
    },
    ...
    methods: {
        ...
        async update() {
            try {
                let url = process.env.Name_api + "/villes/" + this.editedItem.id;
        ...
        async delete(val) {
            console.log(val)
            try {
                let url = process.env.Name_api + "/villes/" + val.id;
